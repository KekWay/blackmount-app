...
- ✅ Система поддержки — гибрид: Telegram + встроенный чат
- ✅ Кнопка поддержки в sidebar меню профиля + на странице профиля
- ✅ Выбор: Telegram / Встроенный чат
- ✅ Полноценный чат с историей, тикетами, статусами
- ✅ Моковые данные (Zustand persist)
- ❌ Supabase таблицы support_tickets + support_messages
- ❌ Telegram webhook для уведомлений администратору
...
- Система уровней (4 уровня):
  - Bronze (15%, от 0 рефералов)
  - Silver (20%, от 5 рефералов)
  - Gold (25%, от 15 рефералов)
  - Diamond (30%, от 35 рефералов)
...
- ✅ Статусы заявок на вывод: pending / processing / completed / rejected
- ✅ Цветные бейджи статусов в списке транзакций
- ✅ Причина отклонения видна пользователю
- ✅ Ссылка "Написать в поддержку" при ожидании
