...
export const leaderboardData: LeaderboardModel[] = [
  ...
  { id: "kling-3.0", name: "Kling 3.0", category: "video", score: 90, speed: 58, accuracy: 88, costEfficiency: 72, creativity: 92, reasoning: 0, analytics: 0, price: 55, votes: 2800, trend: 14.6, description: "Нативное аудио нового поколения. Мультиязычный lip-sync, генерация до 10 секунд.", useCases: ["Видео с озвучкой", "Lip-sync", "Короткие ролики", "Контент"], gradient: "linear-gradient(135deg, #1bfe27 0%, #0f69df 100%)", aiModelRef: "kling", usagePercent: 3.5 },
  ...
  { id: "flux-1-pro", name: "Flux 1.1 Pro", category: "image", score: 89, speed: 78, accuracy: 88, costEfficiency: 88, creativity: 94, reasoning: 0, analytics: 0, price: 7, votes: 14300, trend: 1.6, description: "Фотореалистичная генерация.", useCases: ["Фотореализм", "Портреты", "Продуктовая съёмка"], gradient: "linear-gradient(135deg, #ef4444 0%, #b91c1c 100%)", aiModelRef: "flux", usagePercent: 7 },
  { id: "flux-2-pro", name: "Flux 2 Pro", category: "image", score: 95, speed: 80, accuracy: 94, costEfficiency: 90, creativity: 97, reasoning: 0, analytics: 0, price: 5, votes: 5200, trend: 15.8, description: "Новейшая генерация от Black Forest Labs. Максимальное качество без настроек.", useCases: ["Фотореализм", "Маркетинг", "Дизайн", "Продуктовая съёмка"], gradient: "linear-gradient(135deg, #ef4444 0%, #b91c1c 100%)", aiModelRef: "flux", usagePercent: 5 },
  { id: "flux-1-dev", name: "Flux 1 Dev", category: "image", score: 85, speed: 88, accuracy: 84, costEfficiency: 95, creativity: 88, reasoning: 0, analytics: 0, price: 4, votes: 11200, trend: 1.2, description: "Открытая модель для экспериментов. Отличное соотношение цены и качества.", useCases: ["Эксперименты", "Прототипы", "Стилизация", "LoRA"], gradient: "linear-gradient(135deg, #ef4444 0%, #b91c1c 100%)", aiModelRef: "flux", usagePercent: 3.5 },
  ...
  { id: "veo-3.1-quality", name: "Veo 3.1 Quality", category: "video", score: 93, speed: 40, accuracy: 92, costEfficiency: 52, creativity: 95, reasoning: 0, analytics: 0, price: 220, votes: 5200, trend: 4.6, description: "Кинематографическое видео от Google. Максимальное качество.", useCases: ["8K видео", "Кинематограф", "Реклама"], gradient: "linear-gradient(135deg, #7188e3 0%, #e2694e 100%)", aiModelRef: "veo31", usagePercent: 3 },
  ...
  { id: "kling-2.6-pro", name: "Kling 2.6 Pro", category: "video", score: 91, speed: 55, accuracy: 89, costEfficiency: 68, creativity: 93, reasoning: 0, analytics: 0, price: 45, votes: 4800, trend: 4.2, description: "Профессиональная версия Kling 2.6. Улучшенное качество и стабильность кадра.", useCases: ["Профессиональное видео", "Lip-sync", "Реклама", "Контент"], gradient: "linear-gradient(135deg, #1bfe27 0%, #0f69df 100%)", aiModelRef: "kling", usagePercent: 2.5 },
...
export const SPOTLIGHTS = [
  { title: "Лучший для кода", badge: "#1 Code", model: "Claude Sonnet 4.6", score: 94, iconImg: "/assets/models/leader-claude-code.png", color: "#888ae5", metric: "Точность", metricValue: "95%", aiModelRef: "claude" },
  { title: "Креативность", badge: "#1 Creative", model: "Flux 1.1 Pro Ultra", score: 94, iconImg: "/assets/models/leader-flux-creative.png", color: "#f472b6", metric: "Арт", metricValue: "97", aiModelRef: "flux" },
  ...
  { title: "Лучшее видео", badge: "#1 Video", model: "Veo 3.1", score: 93, iconImg: "/assets/models/leader-veo-video.png", color: "#7188e3", metric: "Качество", metricValue: "93", aiModelRef: "veo31" },
