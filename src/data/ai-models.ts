...
export const aiModels: AIModel[] = [
  {
    ...
    versions: [
      { id: 'gpt-5.4', label: 'ChatGPT 5.4', description: 'Самая мощная', price: 6, tier: 'ultra' },
      { id: 'gpt-5.3', label: 'ChatGPT 5.3', description: 'Умная', price: 5, tier: 'pro' },
      { id: 'chatgpt-5.2', label: 'ChatGPT 5.2', description: 'Надёжный универсал', price: 5, tier: 'ultra' },
  ...
  },
  {
    ...
    versions: [
      { id: 'claude-opus-4.6', label: 'Claude Opus 4.6', description: 'Максимальный интеллект', price: 8, tier: 'ultra' },
      { id: 'claude-sonnet-4.6', label: 'Claude Sonnet 4.6', description: 'Баланс и скорость', price: 5, tier: 'pro' },
      { id: 'claude-opus-4.5', label: 'Claude Opus 4.5', description: 'Глубокий анализ', price: 8, tier: 'ultra' },
  ...
  },
  {
    ...
    versions: [
      { id: 'flux-1.1-pro-ultra', label: 'Flux 1.1 Pro Ultra', description: 'Ультравысокое качество', price: 15, tier: 'ultra' },
  ...
  },
  {
    ...
    versions: [
      { id: 'kling-3.0-pro', label: 'Kling 3.0 Pro', description: 'Топ кинематография', price: { '5s': 85, '10s': 170 }, tier: 'ultra' },
      { id: 'kling-3.0', label: 'Kling 3.0', description: 'Нативное аудио', price: { '5s': 55, '10s': 110 }, tier: 'ultra' },
      { id: 'kling-2.6-pro', label: 'Kling 2.6 Pro', description: 'Кинематограф', price: { '5s': 45, '5s_audio': 85, '10s': 85, '10s_audio': 170 }, tier: 'ultra' },
      { id: 'kling-2.6', label: 'Kling 2.6', description: 'Аудио-визуал', price: 45, tier: 'pro' },
  ...
  },
  {
    ...
    versions: [
      { id: 'veo-3.1-quality', label: 'Veo 3.1 Quality', description: 'Кинематограф', price: 185, tier: 'ultra' },
      { id: 'veo-3.1-fast', label: 'Veo 3.1 Fast', description: 'Быстрое кино', price: 50, tier: 'pro' },
      { id: 'veo-3-quality', label: 'Veo 3 Quality', description: 'Студийное качество', price: 120, tier: 'ultra' },
      { id: 'veo-3-fast', label: 'Veo 3 Fast', description: 'Быстрая классика', price: 35, tier: 'pro' },
    ],
