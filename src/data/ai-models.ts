...
export const aiModels: AIModel[] = [
  {
    ...
    versions: [
      { id: 'gpt-5.4', label: 'ChatGPT 5.4', description: 'Самая мощная', price: 6, tier: 'sub' },
      { id: 'gpt-5.3', label: 'ChatGPT 5.3', description: 'Умная', price: 5, tier: 'sub' },
      { id: 'chatgpt-5.2', label: 'ChatGPT 5.2', description: 'Надёжный универсал', price: 5, tier: 'free' },
      { id: 'chatgpt-5', label: 'ChatGPT 5', description: 'Базовая модель', price: 3, tier: 'free' },
    ...
    glowColors: ['#3e993e', '#2d8a2d', '#4aad4a'],  },
  {
    ...
    versions: [
      { id: 'claude-opus-4.6', label: 'Claude Opus 4.6', description: 'Максимальный интеллект', price: 8, tier: 'sub' },
      { id: 'claude-sonnet-4.6', label: 'Claude Sonnet 4.6', description: 'Баланс и скорость', price: 5, tier: 'free' },
      { id: 'claude-opus-4.5', label: 'Claude Opus 4.5', description: 'Глубокий анализ', price: 8, tier: 'sub' },
      { id: 'claude-sonnet-4.5', label: 'Claude Sonnet 4.5', description: 'Рабочая лошадка', price: 5, tier: 'free' },
      { id: 'claude-sonnet-3.7', label: 'Claude Sonnet 3.7', description: 'Проверенный классик', price: 5, tier: 'free' },
    ...
    glowColors: ['#8B4513', '#A0522D', '#6B3410'],  },
  {
    ...
    versions: [
      { id: 'gemini-3.1-pro', label: 'Gemini 3.1 Pro', description: 'Самая мощная', price: 5, tier: 'sub' },
      { id: 'gemini-3-pro', label: 'Gemini 3 Pro', description: 'Мощный универсал', price: 5, tier: 'free' },
      { id: 'gemini-2.5-pro', label: 'Gemini 2.5 Pro', description: 'Стабильный и точный', price: 3, tier: 'free' },
    ...
    glowColors: ['#3355cc', '#4466dd', '#2244aa'],  },
  {
    ...
    versions: [
      { id: 'nanobanana-2', label: 'NanoBanana 2', description: 'Лучшее качество', price: { '1k': 13, '2k': 19, '4k': 26 }, tier: 'sub' },
      { id: 'nanobanana-pro', label: 'NanoBanana Pro', description: 'Максимальная детализация', price: { '1k': 22, '2k': 22, '4k': 43 }, tier: 'sub' },
      { id: 'nanobanana', label: 'NanoBanana', description: 'Классическая генерация', price: 7, tier: 'free' },
    ],
  ...
  },
  {
    ...
    versions: [
      { id: 'kling-3.0-pro', label: 'Kling 3.0 Pro', description: 'Топ кинематография', price: { '5s': 85, '10s': 170 }, tier: 'sub' },
