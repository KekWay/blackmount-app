...
export const planFeatures: Record<Plan, { coins: number; limits: string[]; features: PlanFeature[] }> = {
  ...
  pro: {
    ...
    features: [
      { icon: 'lock', text: 'Доступ ко всем моделям' },
      { icon: 'lock', text: 'Бесплатно: ', bold: 'ChatGPT 5 mini, Gemini Flash 3, Gemini Flash 2.5' },
...
export const COMPARE_ROWS: CompareRow[] = [
  ...
  { label: 'Veo 3 Quality', price: 120, basic: '2 видео', pro: '4 видео', max: '10 видео' },
  ...
  { label: 'Veo 3 Fast', price: 35, basic: '8 видео', pro: '15 видео', max: '34 видео' },
