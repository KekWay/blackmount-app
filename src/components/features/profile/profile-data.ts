...
export const GEN_MODELS = [
  { model: 'ChatGPT 5.4', price: 6, cat: 'text' as const },
  { model: 'ChatGPT 5.3', price: 5, cat: 'text' as const },
  ...
  { model: 'Claude Opus 4.6', price: 8, cat: 'text' as const },
  { model: 'Claude Sonnet 4.6', price: 5, cat: 'text' as const },
  ...
  { model: 'Gemini 3.1 Pro', price: 5, cat: 'text' as const },
  ...
  { model: 'Veo 3.1 Quality', price: 220, cat: 'video' as const },
